      ...
      child:Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              title: Text("Call us (${aboutUsController.aboutUs.data.contact})"),
              leading: Icon(Icons.call),
              onTap: () {
                aboutUsController.customLaunch('tel: ${aboutUsController.aboutUs.data.contact}');
              },
            ),
            Divider(
              height: 2,
            ...
            ListTile(
              ...
              onTap: () {
                aboutUsController.customLaunch('sms: ${aboutUsController.aboutUs.data.contact}');
              },
            ),
            Divider(
              height: 2,
